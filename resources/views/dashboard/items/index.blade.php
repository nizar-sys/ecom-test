                                ...
                                @forelse ($items as $user)
                                    <tr>
                                        ...
                                        <td class="d-flex jutify-content-center">
                                            <a href="{{route('items.edit', $user->id)}}" class="btn btn-sm btn-warning"><i class="fas fa-pencil-alt"></i></a>
                                            <form id="delete-form-{{ $user->id }}" action="{{ route('items.destroy', $user->id) }}" class="d-none" method="post">
                                                @csrf
                                                @method('DELETE')
                                            </form>
